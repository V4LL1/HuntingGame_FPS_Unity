...
public class EnemySpawnerScene2 : MonoBehaviour
{
    ...
    void SpawnEnemy()
    {
        ...
        float randomX = Random.Range(20f, 130f);
        float randomZ = Random.Range(20f, 150f); // Gera Z aleatório entre 0 e 20
        Vector3 spawnPosition = new Vector3(randomX, 62.22f, randomZ);
